...
namespace operations_research {
	// [START data_model]
	struct DataModel {
		// Time Matrix = Travel times between pairs of locations.
		...
		// Time Windows = The requested time windows for visit for each location.
		...
		// Index of depot where vehicles should start and end their trips.
